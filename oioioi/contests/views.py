...
def problems_list_view(request):
    ...
    if hasattr(controller, 'get_problems_list_context'):
        context.update(controller.get_problems_list_context(request, problems_statements))
    template_name = getattr(controller, 'problems_list_template', 'contests/problems_list.html')
